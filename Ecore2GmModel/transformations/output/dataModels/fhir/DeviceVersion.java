...
This Java source artifact defines the Data Type DeviceVersion of the Data Model fhir.
...
public interface DeviceVersion extends GenericEntity, fhir.BackboneElement {

	EntityType<DeviceVersion> T = EntityTypes.T(DeviceVersion.class);
	...
	@Mandatory
	fhir.Identifier getComponent();
	void setComponent(fhir.Identifier component);
}
