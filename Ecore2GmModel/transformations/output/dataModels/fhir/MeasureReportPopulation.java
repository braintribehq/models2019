...
This Java source artifact defines the Data Type MeasureReportPopulation of the Data Model fhir.
...
public interface MeasureReportPopulation extends GenericEntity, fhir.BackboneElement {

	EntityType<MeasureReportPopulation> T = EntityTypes.T(MeasureReportPopulation.class);
