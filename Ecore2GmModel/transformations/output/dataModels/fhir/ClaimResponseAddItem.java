...
This Java source artifact defines the Data Type ClaimResponseAddItem of the Data Model fhir.
...
public interface ClaimResponseAddItem extends GenericEntity, fhir.BackboneElement {

	EntityType<ClaimResponseAddItem> T = EntityTypes.T(ClaimResponseAddItem.class);
	...
	java.util.List<fhir.ClaimResponseDetail1> getDetail();
	void setDetail(java.util.List<fhir.ClaimResponseDetail1> detail);
