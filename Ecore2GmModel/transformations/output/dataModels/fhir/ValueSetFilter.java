...
This Java source artifact defines the Data Type ValueSetFilter of the Data Model fhir.
...
public interface ValueSetFilter extends GenericEntity, fhir.BackboneElement {

	EntityType<ValueSetFilter> T = EntityTypes.T(ValueSetFilter.class);
