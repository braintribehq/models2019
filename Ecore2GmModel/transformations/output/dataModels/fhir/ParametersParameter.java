...
This Java source artifact defines the Data Type ParametersParameter of the Data Model fhir.
...
public interface ParametersParameter extends GenericEntity, fhir.BackboneElement {

	EntityType<ParametersParameter> T = EntityTypes.T(ParametersParameter.class);
	...
	java.util.List<fhir.ParametersParameter> getPart();
	void setPart(java.util.List<fhir.ParametersParameter> part);
