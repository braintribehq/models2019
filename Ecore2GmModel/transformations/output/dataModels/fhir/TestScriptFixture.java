...
This Java source artifact defines the Data Type TestScriptFixture of the Data Model fhir.
...
public interface TestScriptFixture extends GenericEntity, fhir.BackboneElement {

	EntityType<TestScriptFixture> T = EntityTypes.T(TestScriptFixture.class);
