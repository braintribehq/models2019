...
This Java source artifact defines the Data Type ExplanationOfBenefitDetail of the Data Model fhir.
...
public interface ExplanationOfBenefitDetail extends GenericEntity, fhir.BackboneElement {

	EntityType<ExplanationOfBenefitDetail> T = EntityTypes.T(ExplanationOfBenefitDetail.class);
	...
	java.util.List<fhir.ExplanationOfBenefitSubDetail> getSubDetail();
	void setSubDetail(java.util.List<fhir.ExplanationOfBenefitSubDetail> subDetail);
