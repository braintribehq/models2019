...
This Java source artifact defines the Data Type ClaimSupportingInfo of the Data Model fhir.
...
public interface ClaimSupportingInfo extends GenericEntity, fhir.BackboneElement {

	EntityType<ClaimSupportingInfo> T = EntityTypes.T(ClaimSupportingInfo.class);
