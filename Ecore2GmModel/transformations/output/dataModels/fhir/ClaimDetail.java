...
This Java source artifact defines the Data Type ClaimDetail of the Data Model fhir.
...
public interface ClaimDetail extends GenericEntity, fhir.BackboneElement {

	EntityType<ClaimDetail> T = EntityTypes.T(ClaimDetail.class);
	...
	java.util.List<fhir.ClaimSubDetail> getSubDetail();
	void setSubDetail(java.util.List<fhir.ClaimSubDetail> subDetail);
