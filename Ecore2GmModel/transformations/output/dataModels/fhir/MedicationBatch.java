...
This Java source artifact defines the Data Type MedicationBatch of the Data Model fhir.
...
public interface MedicationBatch extends GenericEntity, fhir.BackboneElement {

	EntityType<MedicationBatch> T = EntityTypes.T(MedicationBatch.class);
