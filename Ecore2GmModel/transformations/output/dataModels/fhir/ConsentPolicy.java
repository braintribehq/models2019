...
This Java source artifact defines the Data Type ConsentPolicy of the Data Model fhir.
...
public interface ConsentPolicy extends GenericEntity, fhir.BackboneElement {

	EntityType<ConsentPolicy> T = EntityTypes.T(ConsentPolicy.class);
