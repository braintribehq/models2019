...
This Java source artifact defines the Data Type CommunicationPayload of the Data Model fhir.
...
public interface CommunicationPayload extends GenericEntity, fhir.BackboneElement {

	EntityType<CommunicationPayload> T = EntityTypes.T(CommunicationPayload.class);
