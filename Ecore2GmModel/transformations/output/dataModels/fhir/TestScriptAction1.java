...
This Java source artifact defines the Data Type TestScriptAction1 of the Data Model fhir.
...
public interface TestScriptAction1 extends GenericEntity, fhir.BackboneElement {

	EntityType<TestScriptAction1> T = EntityTypes.T(TestScriptAction1.class);
	...
	@Mandatory
	fhir.TestScriptAssert getAssert_();
	void setAssert_(fhir.TestScriptAssert assert_);
}
