...
This Java source artifact defines the Data Type ContractRule of the Data Model fhir.
...
public interface ContractRule extends GenericEntity, fhir.BackboneElement {

	EntityType<ContractRule> T = EntityTypes.T(ContractRule.class);
