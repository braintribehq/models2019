...
This Java source artifact defines the Data Type TaskInput of the Data Model fhir.
...
public interface TaskInput extends GenericEntity, fhir.BackboneElement {

	EntityType<TaskInput> T = EntityTypes.T(TaskInput.class);
