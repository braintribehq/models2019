...
This Java source artifact defines the Data Type TestScriptAction of the Data Model fhir.
...
public interface TestScriptAction extends GenericEntity, fhir.BackboneElement {

	EntityType<TestScriptAction> T = EntityTypes.T(TestScriptAction.class);
