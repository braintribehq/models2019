...
This Java source artifact defines the Data Type ClaimItem of the Data Model fhir.
...
public interface ClaimItem extends GenericEntity, fhir.BackboneElement {

	EntityType<ClaimItem> T = EntityTypes.T(ClaimItem.class);
	...
	java.util.List<fhir.ClaimDetail> getDetail();
	void setDetail(java.util.List<fhir.ClaimDetail> detail);
