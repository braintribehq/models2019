...
This Java source artifact defines the Data Type ClaimResponseDetail1 of the Data Model fhir.
...
public interface ClaimResponseDetail1 extends GenericEntity, fhir.BackboneElement {

	EntityType<ClaimResponseDetail1> T = EntityTypes.T(ClaimResponseDetail1.class);
	...
	java.util.List<fhir.ClaimResponseSubDetail1> getSubDetail();
	void setSubDetail(java.util.List<fhir.ClaimResponseSubDetail1> subDetail);
