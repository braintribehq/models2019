...
This Java source artifact defines the Data Type IfcPHMeasure of the Data Model iai.
...
public interface IfcPHMeasure extends GenericEntity, ifc4.IfcDerivedMeasureValue {

	EntityType<IfcPHMeasure> T = EntityTypes.T(IfcPHMeasure.class);
