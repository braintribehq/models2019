...
This Java source artifact defines the Data Type IfcRelAggregates of the Data Model iai.
...
public interface IfcRelAggregates extends GenericEntity, ifc4.IfcRelDecomposes {

	EntityType<IfcRelAggregates> T = EntityTypes.T(IfcRelAggregates.class);
