...
This Java source artifact defines the Data Type IfcSweptDiskSolid of the Data Model iai.
...
public interface IfcSweptDiskSolid extends GenericEntity, ifc4.IfcSolidModel {

	EntityType<IfcSweptDiskSolid> T = EntityTypes.T(IfcSweptDiskSolid.class);

	/* Constants for each property name. */
	java.lang.String Directrix = "Directrix";
	java.lang.String Radius = "Radius";
	java.lang.String RadiusAsString = "RadiusAsString";
	java.lang.String InnerRadius = "InnerRadius";
	java.lang.String InnerRadiusAsString = "InnerRadiusAsString";
	...
	@Description("")
	@Mandatory
	java.lang.Double getInnerRadius();
	void setInnerRadius(java.lang.Double InnerRadius);
	@Description("")
	@Mandatory
	java.lang.String getInnerRadiusAsString();
	void setInnerRadiusAsString(java.lang.String InnerRadiusAsString);
	@Description("")
	@Mandatory
