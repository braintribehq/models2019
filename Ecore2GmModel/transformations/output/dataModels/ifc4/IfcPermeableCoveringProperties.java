...
This Java source artifact defines the Data Type IfcPermeableCoveringProperties of the Data Model iai.
...
public interface IfcPermeableCoveringProperties extends GenericEntity, ifc4.IfcPreDefinedPropertySet {

	EntityType<IfcPermeableCoveringProperties> T = EntityTypes.T(IfcPermeableCoveringProperties.class);
	...
	@Description("")
	@Mandatory
	ifc4.IfcPermeableCoveringOperationEnum getOperationType();
	void setOperationType(ifc4.IfcPermeableCoveringOperationEnum OperationType);
	@Description("")
	@Mandatory
