...
This Java source artifact defines the Data Type IfcDoorStyle of the Data Model iai.
...
public interface IfcDoorStyle extends GenericEntity, ifc4.IfcTypeProduct {

	EntityType<IfcDoorStyle> T = EntityTypes.T(IfcDoorStyle.class);
	...
	@Description("")
	@Mandatory
	ifc4.IfcDoorStyleOperationEnum getOperationType();
	void setOperationType(ifc4.IfcDoorStyleOperationEnum OperationType);
	@Description("")
	@Mandatory
	ifc4.IfcDoorStyleConstructionEnum getConstructionType();
	void setConstructionType(ifc4.IfcDoorStyleConstructionEnum ConstructionType);
	@Description("")
	@Mandatory
