...
This Java source artifact defines the Data Type Binary of the Data Model iso20022.
...
@Description("Any set of values drawn from the value space of 'base64Binary', as specified by W3C Recommendation XML Schema Part 2: Datatypes.")

public interface Binary extends GenericEntity, iso20022.DataType {
	...
	@Description("the maximum number of units of characters")
	@Mandatory
